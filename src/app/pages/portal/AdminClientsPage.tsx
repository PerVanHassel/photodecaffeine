    ...
    <div style={{ padding: isMobile ? "24px 16px 60px" : "48px 40px 80px", maxWidth: "1000px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "32px", flexWrap: "wrap", gap: "12px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ color: "rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))", fontSize: "11px", marginRight: "4px" }}>
      ...
      <div style={{ position: "relative", marginBottom: "24px" }}>
        <Search size={13} color="rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))" style={{ position: "absolute", left: "14px", top: "50%", transform: "translateY(-50%)" }} />
        <input
          type="text"
          ...
          onBlur={(e) => (e.currentTarget.style.borderColor = "rgba(var(--admin-fg-rgb),calc(0.07 * var(--admin-fg-boost)))")}
        />
      </div>
      ...
      {!loading && filtered.length === 0 && !error && (
        <div style={{ textAlign: "center", padding: "64px 0", color: "rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))", fontSize: "13px" }}>
                ...
                >
                  ...
                  {!isMobile && (
                    <div style={{ display: "flex", alignItems: "center", gap: "5px", flex: "0 0 90px" }}>
                      <FolderOpen size={12} color="rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))" />
                      <span style={{ color: "rgba(var(--admin-fg-rgb),calc(0.5 * var(--admin-fg-boost)))", fontSize: "12px" }}>
                  ...
                  {!isMobile && (
                    <div style={{ flex: "0 0 110px", textAlign: "right" }}>
                      <div style={{ color: "rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))", fontSize: "10px", marginBottom: "2px" }}>Joined</div>
                      <div style={{ color: "rgba(var(--admin-fg-rgb),calc(0.4 * var(--admin-fg-boost)))", fontSize: "11px" }}>{formatDate(client.createdAt)}</div>
                    </div>
                  )}

                  {!isMobile && (
                    <div style={{ flex: "0 0 90px", textAlign: "right" }}>
                      <div style={{ color: "rgba(var(--admin-fg-rgb),calc(0.2 * var(--admin-fg-boost)))", fontSize: "10px", marginBottom: "2px" }}>Last active</div>
                      <div style={{ color: "rgba(var(--admin-fg-rgb),calc(0.4 * var(--admin-fg-boost)))", fontSize: "11px" }}>{timeAgo(client.lastSignIn)}</div>
                    </div>
                  )}
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", color: "rgba(var(--admin-fg-rgb),calc(0.3 * var(--admin-fg-boost)))", cursor: "pointer", padding: "2px" }}
              >
                <X size={16} />
              </button>
            </div>
