...
export const translations = {
  en: {
    ...
    services: {
      ...
      bottomNote: "All prices are excluding VAT. Minimum collaboration: 3 months. Custom campaigns available on request.",
      packages: [
        {
          id: "espresso",
          name: "Espresso",
        ...
        },
        {
          ...
          ideal: "Premium dealerships, estate agencies, property developers, real estate investors",
        },
      ],
    },
    socialProof: {
    ...
    automotivePage: {
      ...
      carBrandLabel: "Vehicle make / model (optional)",
      carBrandPlaceholder: "e.g. BMW M3, Porsche 911, Harley-Davidson",
      dateLabel: "Preferred date (optional)",
      datePlaceholder: "e.g. July 20, flexible",
      locationLabel: "Preferred location (optional)",
      locationPlaceholder: "e.g. your garage, a showroom, suggest one",
      ...
      package2Label: "More vehicles or video?",
      package2Title: "Custom shoot",
      package2Body: "Multiple vehicles, cinematic video, full-day or studio — reach out for a tailored quote.",
      package2Button: "Request a custom quote →",
  ...
  nl: {
    ...
    services: {
      ...
      bottomNote: "Alle prijzen zijn exclusief btw. Minimale samenwerking: 3 maanden. Maatwerk campagnes beschikbaar op aanvraag.",
      packages: [
        {
          id: "espresso",
          name: "Espresso",
          ...
          price: "€399,-",
          per: "per maand",
          description: "Gefocust. Scherp. Voor bedrijven die er professioneel uit willen zien zonder meteen alles in te zetten.",
          includes: [
            "1 shootdag per maand",
            "Tot 3 uur op locatie",
            "20 definitief bewerkte foto's",
            "3 korte reels / TikToks",
            "5 story clips",
            "Basis kleurcorrectie & retouche",
            "Verticale exports voor Instagram, TikTok & Facebook",
            "Basis bijschriften inbegrepen",
            "Web + social levering",
            "Online galerij levering",
          ],
          ideal: "Kleine autodealer, zelfstandige makelaar, Airbnb-verhuurder, mkb-bedrijf",
        },
        {
          id: "reserve",
          name: "Reserve",
          ...
          price: "€749,-",
          per: "per maand",
          description: "De volledige PDC-ervaring — cinematisch, strategisch, salesgericht en gebouwd om aandacht te trekken.",
          includes: [
            "2 shootdagen per maand",
            "Tot 4,5 uur per shoot",
            "40–50 definitief bewerkte foto's",
            "6 korte reels / TikToks",
            "10 story clips",
            "1 herovideo per maand",
            "Cinematische kleurcorrectie",
            "Thumbnail covers voor reels",
            "Salesgerichte bijschriften",
            "Maandelijks contentkalender",
            "Maandelijks strategiegesprek",
            "Basis prestatierapport",
            "Web, social & advertentie-klare levering",
          ],
          ideal: "Groeiende autodealer, actieve makelaar, verhuurmaatschappij, vastgoedbeheerder",
        },
        {
          id: "blend",
          name: "Blend",
          ...
          price: "€1.399,-",
          per: "per maand",
          description: "Consistente visuele identiteit over elk kanaal, elke maand. Voor merken die hun regio willen domineren.",
          includes: [
            "4 shootdagen per maand",
            "Wekelijks of tweewekelijks productieschema",
            "80–100 definitief bewerkte foto's",
            "12 korte reels / TikToks",
            "20 story clips",
            "1 premium hero-merkvideo",
            "1 maandelijkse campagnevideo",
            "Volledige cinematische kleurcorrectie",
            "Geavanceerde retouche",
            "Toegewijde merkstijlgids",
            "Maandelijks contentkalender",
            "Maandelijks strategiesessie",
            "Concurrentiecontent-check",
            "Prestatierapport",
            "Prioriteitsplanning",
            "Advertentie-klare exports",
            "Websitebanners",
            "Levering binnen een week",
          ],
          ideal: "Premium autodealer, makelaarskantoor, projectontwikkelaar, vastgoedbelegger",
        },
      ],
    },
    socialProof: {
    ...
    automotivePage: {
      ...
      carBrandLabel: "Voertuigmerk / model (optioneel)",
      carBrandPlaceholder: "bijv. BMW M3, Porsche 911, Harley-Davidson",
      dateLabel: "Gewenste datum (optioneel)",
      datePlaceholder: "bijv. 20 juli, flexibel",
      locationLabel: "Gewenste locatie (optioneel)",
      locationPlaceholder: "bijv. eigen garage, showroom, stel er één voor",
      ...
      package2Title: "Maatwerk shoot",
      package2Body: "Meerdere voertuigen, cinematische video, volledige dag of studio — vraag een offerte op maat aan.",
